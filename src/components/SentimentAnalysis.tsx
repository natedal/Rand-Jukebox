        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <select
              ...
              className="px-3 py-2 rounded-lg bg-midnight-800 border border-midnight-700 text-white text-sm"
            >
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {sortedQueueRatings.map((song) => (
                <div
                  key={song.song_id}
                  className="flex items-center gap-4 p-4 rounded-xl bg-midnight-800/50 border border-midnight-700"
                >
          ...
          {selectedSongId ? (
            ...
            <div>
              ...
              <div className="flex gap-2 mb-4">
                ...
                <button
                  onClick={() => {
                    const input = document.querySelector('input[placeholder="Enter song ID"]') as HTMLInputElement;
                    if (input?.value.trim()) {
                      setSelectedSongId(input.value.trim());
                    }
                  }}
